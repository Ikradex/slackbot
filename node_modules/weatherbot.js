	...
	if(reportType == WeatherBot.REPORT_CURRENT) {
		...
		reportJson.days.forEach(function(dayJson) {
			...
			attachments.push({
				...
				"fields": [{
					"title": "Temp",
					"value": vsprintf("Morn: %s °C, Day: %s °C, Eve: %s °C, Night: %s °C", [dayJson.temp.morn, dayJson.temp.day, dayJson.temp.eve, dayJson.temp.night]),
					"short": true
				}, {
					"title": "Overcast",
					"value": dayJson.clouds + "%",
