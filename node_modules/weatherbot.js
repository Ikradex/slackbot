				...
				if (!error && resp.statusCode === 200) {
					...
					if (reportJson.cod === 200) {
						...
						var attachment = {
							...
							"text": vsprintf("*%s:* %s", [formatDateTime(dateTime), weatherDesc]),
							"fields": [{
								"title": "Temp",
...
function formatDateTime(secs) {
	var date = new Date();
	if (secs) date.setSeconds(secs);
	...
	return vsprintf("%s, %s %s", [day, date.getDate(), month]);
}
